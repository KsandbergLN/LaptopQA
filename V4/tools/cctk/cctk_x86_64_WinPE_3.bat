...
REM    %2 Path to extracted CCTK toolkit
...
::copy /Y %CCTKPATH%\*.dll    %WINPEPATH%\mount\CCTK\X86_64\HAPI
::xcopy %CCTKPATH%\HAPI\*.*    %WINPEPATH%\mount\CCTK\X86_64\HAPI /S /E /i /Y
xcopy %CCTKPATH%\X86_64\HAPI\*.*    %WINPEPATH%\mount\CCTK\X86_64\HAPI /S /E /i /Y
xcopy %CCTKPATH%\X86_64\*.*	   %WINPEPATH%\mount\CCTK\X86_64 /S /E /i /Y
rem copy /Y %CCTKPATH%\Readme.txt    %WINPEPATH%\mount\CCTK\X86_64
...
echo X:\CCTK\X86_64\HAPI\hapint -i -k C-C-T-K -p X:\CCTK\X86_64\HAPI\ >> %WINPEPATH%\mount\windows\system32\STARTNET.CMD
...
%AIKTOOLS%\X86\imagex /BOOT /COMPRESS maximum /CAPTURE %WINPEPATH%\mount\ %WINPEPATH%\WIM\boot.wim "CCTK WinPE 3 Image"
...
%AIKTOOLS%\x86\oscdimg -n -b%WINPEPATH%\etfsboot.com %WINPEPATH%\ISO %WINPEPATH%\WIM\CCTK_x86_64_3.iso
...
echo ***********************************************************************
echo.
echo Example: cctk_x86_64_WinPE_3.bat C:\winsevpe_x64 C:\Progra~1\Dell\CCTK\
echo This installs the HAPI (Instrumentation)
echo drivers found in the C:\Progra~1\Dell\CCTK\X86_64\HAPI folder to the base
