...
REM    Most of these drivers are essential for CCTK tools to work correctly.
REM  
REM Arguments:
...
echo.
echo Example: cctk_x86_64_WinPE.bat C:\vistape_x64 C:\Progra~1\Dell\CCTK\
echo This installs the HAPI (Instrumentation)
echo drivers found in the C:\CCTK\X86_64\HAPI folder to the base Windows PE image
